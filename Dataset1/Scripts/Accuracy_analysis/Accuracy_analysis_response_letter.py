...
# -*- coding: utf-8 -*-
"""
TRF Accuracy Analysis: Phoneme Onset vs Surprisal/Entropy Comparison

This script calculates the explained variance of phoneme onset features versus
phoneme surprisal/entropy features by comparing nested TRF models for Sentences 
and Word_list conditions.
...
def plot_boxplots(df, stats_results, output_path=None):
    ...
    # Order: [Sentences vs Word_list for Phoneme Onset, 
    #         Sentences vs Word_list for Phoneme Surprisal/Entropy,
    #         Phoneme Onset vs Surp/Ent for Sentences, 
    #         Phoneme Onset vs Surp/Ent for Word_list]
    sig_signs = ['n.s.', 'n.s.', '**', '**']
...
def main():
    ...
    print("="*70)
    print("TRF ACCURACY ANALYSIS: PHONEME ONSET VS SURPRISAL/ENTROPY")
    print("="*70)
    ...
    # Save data
    output_csv = RESULTS_PATH / 'Sanne_Accuracies_revision_STG_delta_theta_sources_phoneme_onset_vs_suprisal_entropy.csv'
    ...
    print("="*70)
    output_plot = RESULTS_PATH / 'phoneme_onset_vs_surprisal_entropy_boxplot.svg'
